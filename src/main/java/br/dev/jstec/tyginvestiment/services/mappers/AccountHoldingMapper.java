...
import br.dev.jstec.tyginvestiment.models.*;
...
public abstract class AccountHoldingMapper {
    ...
    public AssetTransaction toTransactionByCreateHolding(AccountHolding entity) {
        AssetTransaction transaction = new AssetTransaction();
        transaction.setAccount(entity.getAccount());
        transaction.setAsset(entity.getAsset());
